export const projectContent =  [
  {
    ...
    'summary': 
      ...
      20 minutes.`,
    'paragraphs': [
      ` A Capital One web application called Dealer Navigator 
  ...
  },
  {
    ...
    'paragraphs': [
      ...
      built collapsible banners for previewing uploaded documents, and styled tables to
      clearly communicate dealer funding requirements. In order to leverage
  ...
  },
  {
    ...
    'summary': 
    `I architected and developed a Java Spring Boot REST API that provides 
    application-specific funding requirements, reducing the number of applications
    with missing documents by 55%.`,
    'paragraphs': [
      ...
      the number of "clean deals" (deals that provide all required documentation on
      the first try) increased drastically.`
    ]
  },
  {
    'title': 'Classifying And Extracting Documents',
    'summary':
    ...
    'paragraphs': [
      `For the pipeline, I built a dockerized image preprocessing Python microservice.
      The tool leverages OpenCV to grayscale images, convert files to JPEG, and perform
      content isolation transformations to increase accuracy. I deployed the container 
      on an Amazon Web Services ECS cluster.`,
      `When an upload occurs, the orchestrator places a message, which
      my preprocessing service consumes, in an SQS queue. Upon completion, my service saves the 
      ...
      ` I also built an Angular 4 GUI to help retrain the classification
      model. The GUI allows users to view uploaded images next to their classifications.
      If a user identifies a misclassification, he or she can select the correct label
